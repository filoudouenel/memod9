...
class Carte extends Component {
  ...
  render() {
    return (
      <article
        className="bg-secondary text-light p-2 mb-2 mt-4 rounded carte d-flex justify-content-between"
      ...
      >
        ...
        >
          <IoIosArrowDropleft
            onClick={() =>
              this.props.onMoveCard(this.props.card, this.props.colonne, "left")
            }
          />
        </div>
        <section>
